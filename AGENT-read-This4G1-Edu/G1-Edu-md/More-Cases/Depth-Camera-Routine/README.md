...
Source URL: `https://support.unitree.com/home/en/G1_developer/depth_camera_instruction -->
...
Original HTML: `More-Cases/Depth-Camera-Routine/宇树科技 文档中心.html`
...
The G1 robot depth camera is located overhead and is a realsense D435i. The camera includes binocular infrared camera (global shutter), laser transmitter, RGB camera (rolling shutter), and 6-axis imu.
...
On windows,the download Intel RealSense. Viewer.Exe links: https://github.com/IntelRealSense/librealsense/releases On Linux, need to compile the SDK installation.
...
Before use, you need to install librealsense on the robot's NX computer platform. When the hardware connection is normal, enter realsense-viewer on the terminal to open the software. You can view:

## 2.2 Get data via ros

Ros camera driver code warehouse: https://github.com/IntelRealSense/realsense-ros Refer to the readme file of the code repository for detailed instructions. In daily use, it is recommended to obtain data through the sdk and process it.
