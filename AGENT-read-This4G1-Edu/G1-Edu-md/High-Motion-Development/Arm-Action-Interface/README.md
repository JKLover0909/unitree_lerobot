...
Source URL: `https://support.unitree.com/home/en/G1_developer/arm_action_interface -->
...
Original HTML: `High-Motion-Development/Arm-Action-Interface/宇树科技 文档中心.html`
...
The Arm Action Service Interface relies on the built-in motion control. After entering debug mode, the built-in motion control exits completely, and the Arm Action Service becomes invalid. Please ensure the surrounding environment is safe when using the Arm Action Service Interface, especially when triggering the playback of taught actions.
...
You can turn off Unitree's built-in Arm Control Service through the Device State Service Interface . The service name for the Arm Action Service is: g1_arm_example .
