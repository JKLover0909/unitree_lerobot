...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.act_lite.modeling_act_lite import ACTLitePolicy

        return ACTLitePolicy
    elif name == "vqbet":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "act_lite":
        return ACTLiteConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTLiteConfig):
        from lerobot.policies.act_lite.processor_act_lite import make_act_lite_pre_post_processors

        processors = make_act_lite_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
