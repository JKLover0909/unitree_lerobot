...
EE_CONFIG: dict[str, dict[str, Any]] = {
    ...
    # FTP hands: same 6-dof layout, different DDS topics (rt/inspire_hand/ctrl/l|r).
    # This is the one that matches hardware teleoped with --ee=inspire_ftp.
    "inspire_ftp": {
        "controller": Inspire_FTP_Controller,
        "dof": 6,
        "shared_mem_type": "Array",
        "shared_mem_size": 6,
        # "out_len": 12,
